...
function MemoryCard({ 
  ...
  return (
    ...
    >
      <motion.div style={{ y: scrollY }} className="absolute inset-0 w-full h-[120%] -top-[10%] z-0">
        {isVideo ? (
          <video 
          ...
          <img 
            ...
            onLoad={() => {
              ...
              console.log('Image src:', MEMORIES[index].image);
              console.log('Image exists:', MEMORIES[index].image ? 'YES' : 'NO');
              console.log('File extension:', MEMORIES[index].image?.split('.').pop()?.toUpperCase());
              console.log('File size check:', MEMORIES[index].image ? 'File should exist' : 'Checking file...');
              console.log('Current index:', index);
              console.log('Memory title:', MEMORIES[index]?.title || 'No title');
              console.log('Memory data:', JSON.stringify(MEMORIES[index], null, 2));
            ...
            onError={() => {
              ...
              console.log('Image src:', MEMORIES[index].image);
              console.log('Current index:', index);
              console.log('Error details: Could not load image.');
            }}
          />
        )}
      </motion.div>

      <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent p-12 flex flex-col justify-end z-10">
           ...
           <div className="flex flex-col items-center gap-12 relative z-10">
               ...
               <div className="space-y-4">
                    <p className="font-serif italic text-3xl text-primary">
                      {isPlaying ? "Playing your heartfelt message..." : "Click to hear Parth's voice apology."}
                    </p>
                    <p className="text-primary/30 font-sans text-sm tracking-widest uppercase font-bold">
                       {isPlaying ? "Playing audio" : "Recorded with love for Anshi"}
                    </p>
                 </div>
               </div>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-24">
          ...
          <motion.div 
            ...
            className="lg:w-3/4 w-full aspect-[4/3] max-w-lg mx-auto relative group"
          >
             ...
             <div className="relative h-full overflow-hidden shadow-[0_40px_80px_rgba(0,0,0,0.3)] border-8 border-white p-2">
                {/* Anniversary Image - Add your image file here */}
                <img 
                  src="/first-date.jpg" 
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center p-4 md:p-6 z-50 overflow-hidden bg-primary">
      ...
      <div className="absolute inset-0 opacity-40">
        <div className="absolute inset-0 bg-[url('/first-date.jpg')] bg-cover bg-center blur-2xl scale-110" />
      ...
      <section className="py-60 px-6 bg-white overflow-hidden border-t border-primary/5">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10 auto-rows-[400px] md:auto-rows-[500px]">
             ...
             <MemoryCard index={4} className="md:col-span-4" yRange={[40, -40]} delay={0.25} />
